...
document.querySelector(".shelter").onclick = function(){
    window.location.href = "https://rolling-scopes-school.github.io/valeryaleshka-JS2020Q3/shelter/pages/main/index.html";
}

document.querySelector(".momentum").onclick = function(){
